...
Target runtime: 2 minutes 30 seconds. Record in English at 1440 × 900 or a similarly legible desktop viewport.
...
Open **Inspect exposed tools**.

“Instead of scraping this interface, the agent sees four structured WebMCP tools registered directly by the page. Read operations are marked read-only. The offer tool creates only a reversible draft.”

## 0:45–1:35 — Agent collaboration
...
Point out the draft banner and say:
